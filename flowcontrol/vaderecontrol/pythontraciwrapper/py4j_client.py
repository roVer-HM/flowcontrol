...
from . import ControlWrapper, PersonapiWrapper, SimulationapiWrapper, VadereapiWrapper, PolygonapiWrapper
    ...
    def _start_entrypoint(self):
        if self.start_server:
            if self.entrypoint_jar == '':
                jar_path = os.path.join(self.vadere_base_path, "VadereManager/target/vadere-server.jar")
            else:
