...
def start_server(strategy : Strategy, port=None, host= "127.0.0.1", label="default", verbose=False,
          log=True, traceGetters=True, stdout=None):
    """
    Start a sumo server using cmd, establish a connection to it and
    store it under the given label. This method is not thread-safe.
    """
